...
if __name__ == "__main__":
    ...
    spark = SparkSession        .builder        .appName("ProductCountByCountry")        .getOrCreate()
    ...
    schema = StructType([StructField('country', StringType(), True),StructField('cheese count', StringType(), True)])
